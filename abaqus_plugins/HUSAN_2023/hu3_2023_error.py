...
def HU3_2023(partname_k, D_k, bata_k, ZGD, YS_k, S_k):
    ...
    s.ConstructionLine(point1=(p1_x, 0.0), point2=(p1_x, -70.0))
    s.CoincidentConstraint(entity1=v[0], entity2=g[4], addUndoState=False)
    s.ConstructionLine(point1=(p1_x, 0.0), point2=(270.0, 75.0))
    s.CoincidentConstraint(entity1=v[0], entity2=g[5], addUndoState=False)
    s.AngularDimension(line1=g[4], line2=g[3], textPoint=(279.373809814453, 26.7832260131836), value=120.0)
    s.AngularDimension(line1=g[5], line2=g[3], textPoint=(281.234588623047,  -9.13857173919678), value=120.0)
    ...
    s.ConstructionLine(point1=(p2_x, 0.0), point2=(p2_x+15, -40.0))
    ...
    s.ConstructionLine(point1=(p2_x+15, 0.0), point2=(p2_x-15,   -40))
    ...
    s.Parameter(name='YS_K', path='dimensions[6]', expression='YS',  previousParameter='L3')
